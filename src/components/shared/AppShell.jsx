    ...
    <>
      <style>{`
        *{font-family:${F}!important;}
        ...
        .nl{display:flex;align-items:center;gap:9px;padding:9px 12px;border-radius:11px;text-decoration:none;margin-bottom:1px;color:rgba(255,255,255,0.38);font-size:13px;font-weight:500;transition:all 0.18s;border:1px solid transparent;}
        ...
        .nl .ni{width:27px;height:27px;border-radius:8px;display:flex;align-items:center;justify-content:center;flex-shrink:0;transition:background 0.18s;}
      ...
      <div className="al">
        ...
        {/* Per-page accent glow top-right */}
          ...
          <nav style={{ flex:1, padding:'10px 8px', overflowY:'auto' }}>
            {NAV.map(item => (
              <NavLink key={item.to} to={item.to} end={item.to==='/'}
                ...
                <span className="ni" style={{}}>{ICONS[item.icon]}</span>
                {item.label}
              </NavLink>
            ))}
          </nav>
